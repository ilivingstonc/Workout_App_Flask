...
def get_all_workouts():
    ...
    all_workouts = [model_to_dict(d, max_depth=0) for d in models.Workout.select()]
    return jsonify(data=all_workouts, status={'code': 200, 'message': 'Success'})
...
def delete_workout(id):
    # Get the workout we are trying to delete. Could put in try -> except because
